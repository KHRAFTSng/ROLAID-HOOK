...
contract AuctionServiceTest is Test {
    ...
    function setUp() public {
        ...
        vault = new SettlementVault(address(0x1000), address(0x2000), 7000); // 70/30 split
    ...
    function testSubmitSettlement() public {
        ...
        service.submitSettlement(id, APP_ID, DIGEST, address(0xB1DD3), 1 ether, settlementData);
    ...
    function testRevertsWithoutAttestation() public {
        ...
        service.submitSettlement(id, APP_ID, keccak256("wrong"), address(0xB1DD3), 1 ether, settlementData);
    }
}
